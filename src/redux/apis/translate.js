...
/**
 *@method GET /{baseUrl}/request?text=${inputString}&itc=${languageCode}&num=5&cp=0&cs=1&ie=utf-8&oe=utf-8&app=demopage
 ...
 * @response ["SUCCESS",[["Hello",["হ্যালো","হেল্লো","হেল্ল","হেলাল","হেলো"],[],{"candidate_type":[0,0,0,0,0]}]]]
 */
